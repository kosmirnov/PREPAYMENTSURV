...
#funktioniert, problem ist bloß, dass ITM nicht proportional, globaler test wird allerdings abgelehnt.
...
ggcoxzph(ass,var=c("MYSCORE:START"),  resid=FALSE,se=TRUE)



ggsurvplot(survfit(FINAL_BOTH))





ggcoxzph(ass1,var=c("OPTION.CATOTM","OPTION.CATITM","OLTV.CAT<65","OLTV.CAT>80","PROFIT.SIGN1"),  resid=FALSE,se=TRUE)
extractAIC(test)
